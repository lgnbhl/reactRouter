...
#
# This example runs two Form(navigate = FALSE) searches with different keys.
  ...
  router = createMemoryRouter(
    Route(
      ...
      element = div(
        ...
        tags$p(
          "State A: ",
          useFetcher(tags$code(), fetcherKey = "search-a", selector = "state")
        ),
        tags$p(
          "Results A: ",
          useFetcher(tags$span(), fetcherKey = "search-a", selector = "data")
        ),
        ...
        tags$p(
          "State B: ",
          useFetcher(tags$code(), fetcherKey = "search-b", selector = "state")
        ),
        tags$p(
          "Results B: ",
          useFetcher(tags$span(), fetcherKey = "search-b", selector = "data")
        ),
