...
#
# Key: use FetcherForm() (not Form()) to submit. FetcherForm is bound to a
# fetcher instance identified by fetcherKey. useFetcher() with the same
# fetcherKey reads that fetcher's state and data.
#
...
ui <- RouterProvider(
  Route(
    ...
    element = div(
      ...
      # FetcherForm submits to /search without navigating.
