...
Thanks to the client side routing provided by React Router, you can also create multiple pages in your Quarto / Rmarkdown documents (as no server is required).
