...
Another workaround is to reload the session when clicking on a page link
...
More examples of this issue are given
[here](https://github.com/lgnbhl/reactRouter/issues/1). Please contact
me if you have a solution to this issue.
